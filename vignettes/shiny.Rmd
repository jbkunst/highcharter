...
dinfo <- future_map_dfr(apps, function(x = "03-shinydashboard-n-spakrlines"){
# dinfo <- map_df(apps, function(x = "05-arma"){ 
  
  message(x)
  
  url_app <- str_glue("http://jbkunst.shinyapps.io/", x)
  
  url_src <- str_glue("https://github.com/jbkunst/highcharter-shiny/tree/master/", x)
  ...
  img_uri <- knitr::image_uri(tmp_img)
