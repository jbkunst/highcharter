...
highchart(type = "map") %>%
  ...
  hc_add_series(data = plates, type = "mapline", geojson = TRUE, lineWidth = 2, zIndex = 0,
                name = "Plates", tooltip = list(pointFormat = "{point.properties.TIPO}")) %>%
  hc_add_series(data = volcano, type = "mappoint", geojson = TRUE, color = hex_to_rgba("#434348", 0.4),
