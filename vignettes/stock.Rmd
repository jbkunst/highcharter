---
title: Stocks with highstock
author: Joshua Kunst
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
description: >
  The highcharter package include [highstocks](https://www.highcharts.com/demo/stock)
  libraries from highcharts to create stock or general timeline charts.
...
use the `hc_add_series()` function. Dont' forget to specify `type = "stock"` to
...
hc <- highchart(type = "stock") %>% 
  ...
  hc_add_series(eurkpw, id = "eurkpw", name = "EUR/KPW")
