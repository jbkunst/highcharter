...
#' Adding HTML labels to highcharts objects
#'
#' Adds a HTML labels to anywhere in the chart area.
#'
#' @param hc A \code{highchart} \code{htmlwidget} object.
#' @param ... Options defined in \url{https://api.highcharts.com/highcharts/labels}.
#'
#' @examples
#'
#' data(citytemp)
