...
This outlines how to propose a change to highcharter. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jbkunst/highcharter", fork = TRUE)`.
...
Please note that the highcharter project is released with a [Contributor
Code of Conduct](https://jkunst.com/highcharter/CODE_OF_CONDUCT.md). By
