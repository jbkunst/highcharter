...
# install.packages(c("treemap", "mvtnorm", "rsvg", "tidytext", "geojsonio"))

# fs::file_copy("pkgdown/extra.css", new_path = "docs/extra.css", overwrite = TRUE)

# This generates the HTML that is later read by the README/index iframe
source("pkgdown/index-examples.R")
